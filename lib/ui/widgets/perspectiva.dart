...
class PerspectivaLista extends StatefulWidget {
  const PerspectivaLista({
    super.key,
  ...
  @override
  PerspectivaListaState createState() => PerspectivaListaState();
}

class PerspectivaListaState extends State<PerspectivaLista> {
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return Stack(
          children: [
            //---------------------------------------
            // Perspectiva Itens Lista
            //---------------------------------------
            Padding(
              padding: widget.padding,
              child: _PerspectivaItens(
...
class _PerspectivaItens extends StatelessWidget {
  const _PerspectivaItens({
...
class _TransformacaoItem extends StatelessWidget {
  const _TransformacaoItem({
    required this.heightItem,
    required this.child,
